...
main_map = "data/companies_map copy---what we've been using.json"
not_found = "data/companies_not_found_MASTER LIST.json"

"""
  "capital southwest corp": {
    "reviews_url": "https://www.glassdoor.com/Reviews/Capital-Southwest-Reviews-E1225.htm?filter.defaultEmploymentStatuses=false&filter.defaultLocation=false&filter.employmentStatus=FREELANCE&filter.employmentStatus=PART_TIME&filter.employmentStatus=CONTRACT&filter.employmentStatus=INTERN&filter.employmentStatus=REGULAR"
  },
  "capital southwest rp": {
    "reviews_url": "https://www.glassdoor.com/Reviews/Southwest-Airlines-Reviews-E611.htm?filter.defaultEmploymentStatuses=false&filter.defaultLocation=false&filter.employmentStatus=FREELANCE&filter.employmentStatus=PART_TIME&filter.employmentStatus=CONTRACT&filter.employmentStatus=INTERN&filter.employmentStatus=REGULAR"
  },
"""
